...
save_dir = os.path.join(os.path.dirname(os.path.dirname(current_dir)), 'output', 'dual', 'ResNet18')
...
class DualResNet18(nn.Module):
    def __init__(self):
        super().__init__()
        self.orig_branch = get_custom_resnet18()
        self.diff_branch = get_custom_resnet18()
