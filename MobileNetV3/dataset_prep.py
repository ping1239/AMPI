...
# 상대 경로를 사용한 데이터 위치 지정
ab_path = '../ResNet18/abnormal_image/abnormal_image.npy'
norm_path = '../ResNet18/normal_image/normal_image.npy'
save_dir = './dataset'
...
print("Loading raw tensors (using relative paths)...")
